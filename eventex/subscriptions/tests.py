...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Ramona Mello', email.body)
        self.assertIn('14761210796', email.body)
        self.assertIn('ramonabritods@gmail.com', email.body)
        self.assertIn('21-98536-5664', email.body)
